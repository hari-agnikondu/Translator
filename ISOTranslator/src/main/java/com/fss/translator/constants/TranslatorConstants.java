...
/**
 * Translator constants defined for constants declaration The keys are mapped to
 * key-value pairs in requestData Map
 * 
...
public class TranslatorConstants {
	...
	public static final String MESSAGEFORMAT_ISO8583 = "ISO8583";
	public static final String MESSAGEFORMAT_ISO020022 = "ISO20022";
	...
	public static final String IS_OPTIONAL = "O";
	...
	public static final String MAPPINGPROPERTY = "mappingproperty";
	...
	public static final String DOWNLOAD_TYPE = "application/text";
	public static final String ROOT_DOCUMENT = "Document";
	public static final String AESKEY = "aesKey";
	public static final String ISOHEADER = "isoheader";
