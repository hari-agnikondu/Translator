...
/**
 * ResponseMessages class defines all the response message keys for the response
 * messages returned by the Translator Service. The keys are mapped to key-value
 * pairs in messages.properties
 * 
